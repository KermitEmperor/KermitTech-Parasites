...
mods.extendedcrafting.TableCrafting.addShaped(<environmentaltech:void_botanic_miner_cont_1> * 1, [
    [<ore:blockGlass>, <ore:blockGlass>, <ore:blockIron>, <ore:blockGlass>, <ore:blockGlass>], 
...
mods.extendedcrafting.TableCrafting.addShaped(<environmentaltech:void_botanic_miner_cont_2> * 1, [
    [<ore:blockErodium>, <ore:blockIron>, <ore:blockGlass>, <ore:blockIron>, <ore:blockErodium>], 
    ...
    [<ore:blockErodium>, <ore:plateConstantan>, <environmentaltech:void_botanic_miner_cont_1>, <ore:plateConstantan>, <ore:blockErodium>], 
    [<environmentaltech:interconnect>, <environmentaltech:interconnect>, <ore:etLaserLens>, <environmentaltech:interconnect>, <environmentaltech:interconnect>]
]);

recipes.remove(<environmentaltech:void_botanic_miner_cont_3>);
mods.extendedcrafting.TableCrafting.addShaped(<environmentaltech:void_botanic_miner_cont_3> * 1, [
	[<ore:plateConstructionAlloy>, <ore:plateConstantan>, <ore:plateConstructionAlloy>, <ore:blockPlatinum>, <ore:plateConstructionAlloy>, <ore:plateConstantan>, <ore:plateConstructionAlloy>], 
	...
	[<ore:blockKyronite>, <ore:gearElectrum>, <ore:gearCobalt>, <environmentaltech:void_botanic_miner_cont_2>, <ore:gearCobalt>, <ore:gearElectrum>, <ore:blockKyronite>], 
...
mods.extendedcrafting.TableCrafting.addShaped(<environmentaltech:void_botanic_miner_cont_4> * 1, [
	[<ore:plateElectricalSteel>, <ore:plateEnergeticSilver>, <ore:plateElectricalSteel>, <ore:blockPlatinum>, <ore:plateElectricalSteel>, <ore:plateEnergeticSilver>, <ore:plateElectricalSteel>], 
	...
	[<ore:blockPladium>, <ore:gearElectrum>, <ore:plateRedstoneAlloy>, <environmentaltech:void_botanic_miner_cont_3>, <ore:plateRedstoneAlloy>, <ore:gearElectrum>, <ore:blockPladium>], 
...
mods.thermalexpansion.Transposer.addFillRecipe(<environmentaltech:void_botanic_miner_cont_5>, <contenttweaker:void_miner_cont_5_base>, <liquid:redstone> * 500, 8000);

recipes.remove(<environmentaltech:void_botanic_miner_cont_6>);
mods.thermalexpansion.Transposer.addFillRecipe(<environmentaltech:void_botanic_miner_cont_6>, <contenttweaker:void_miner_cont_6_base>, <liquid:redstone> * 500, 8000);