...
mods.extendedcrafting.TableCrafting.addShaped(<environmentaltech:nano_cont_personal_1>, [
	...
	[<ore:blockLitherite>, <ore:plateCopper>, <environmentaltech:nano_cont_ranged_1>, <ore:plateCopper>, <ore:blockLitherite>], 
...
mods.extendedcrafting.TableCrafting.addShaped(<environmentaltech:nano_cont_personal_2>, [
	...
	[<ore:blockErodium>, <ore:plateLead>, <environmentaltech:nano_cont_personal_1>, <ore:plateLead>, <ore:blockErodium>], 
...
mods.extendedcrafting.TableCrafting.addShaped(<environmentaltech:nano_cont_personal_3>, [
	...
	[<ore:blockKyronite>, <ore:stickElectrum>, <ore:plateCobalt>, <environmentaltech:nano_cont_personal_2>, <ore:plateCobalt>, <ore:stickElectrum>, <ore:blockKyronite>], 
...
mods.extendedcrafting.TableCrafting.addShaped(<environmentaltech:nano_cont_personal_4>, [
	...
	[<ore:blockPladium>, <ore:plateDiamond>, <ore:gearElectricalSteel>, <environmentaltech:nano_cont_personal_3>, <ore:gearElectricalSteel>, <ore:plateDiamond>, <ore:blockPladium>], 
...
mods.thermalexpansion.Transposer.addFillRecipe(<environmentaltech:nano_cont_personal_5>, <contenttweaker:nano_cont_personal_5_base>, <liquid:redstone> * 500, 8000);
mods.extendedcrafting.TableCrafting.addShaped(<contenttweaker:nano_cont_personal_5_base>, [
	...
	[<ore:blockIonite>, <ore:plateRedstoneAlloy>, <environmentaltech:connector>, <extendedcrafting:material:10>, <environmentaltech:nano_cont_personal_4>, <extendedcrafting:material:10>, <environmentaltech:connector>, <ore:plateRedstoneAlloy>, <ore:blockIonite>], 
...
mods.thermalexpansion.Transposer.addFillRecipe(<environmentaltech:nano_cont_personal_6>, <contenttweaker:nano_cont_personal_6_base>, <liquid:redstone> * 500, 8000);
mods.extendedcrafting.TableCrafting.addShaped(<contenttweaker:nano_cont_personal_6_base>, [
	...
	[<ore:blockAethium>, <ore:gearElectricalSteel>, <extendedcrafting:material:18>, <ore:plateTin>, <environmentaltech:nano_cont_personal_5>, <ore:plateConstantan>, <extendedcrafting:material:18>, <ore:gearElectricalSteel>, <ore:blockAethium>], 
