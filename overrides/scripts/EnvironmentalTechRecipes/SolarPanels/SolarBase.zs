...
var ThunerBolt5Base = VanillaFactory.createBlock("solar_cont_5_base", <blockmaterial:rock>);
...
var ThunerBolt6Base = VanillaFactory.createBlock("solar_cont_6_base", <blockmaterial:rock>);
